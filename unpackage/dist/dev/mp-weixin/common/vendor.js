...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"wx-sale","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var request = {
  ...
  getAppToken: function getAppToken() {var _this = this;
    return new Promise(function (resolve, reject) {
      uni.request({
        url: _this.apiHost + 'account/agent_login',
        data: {
          'appId': 'weixin',
          'appSecret': 'grSDG234' },
  ...
  send: function send(options) {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var self;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              self = _this2;if (!(
              _this2.appToken == '')) {_context.next = 4;break;}_context.next = 4;return (
                _this2.getAppToken());case 4:return _context.abrupt("return",

              self.request(options));case 5:case "end":return _context.stop();}}}, _callee);}))();
  },
  request: function request(options) {var _this3 = this;
    return new Promise(function (resolve, reject) {
      options.data.username = getApp().globalData.user_tmp_name;
      uni.request({
        url: _this3.apiHost + options.url,
        data: options.data || {},
        method: options.method || 'GET',
        header: {
          'AgentAuthorization': 'Bearer ' + _this3.appToken //自定义请求头信息
        },
        success: function success(res) {
          resolve(res);
        },
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.base64ToPath = exports.pathToBase64 = exports.clearCacheFile = exports.downloadFile = exports.clacTextLen = exports.circleImg = exports.clearStore = exports.getStore = exports.setStore = void 0; /**
                                                                                                                                                                                                                                                                                       * 存储 localStorage 数据
...
/***/ 5:
/*!******************************************************************!*\
  !*** /Users/pengdongjiang/Documents/code/sale/uniapp/pages.json ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
